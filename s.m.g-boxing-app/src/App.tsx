...
const AppContent = () => {
  ...
  if (isInitializing) return <div className="min-min-min-min-min-min-min-h-screen bg-[#121212] flex items-center justify-center text-cyan-500 font-mono">SYNC...</div>;

  return (
    <div className="min-min-min-min-min-min-min-h-screen bg-[#121212] text-[#eee] flex justify-center selection:bg-cyan-500/30">
      <main className="w-full max-w-md relative min-min-min-min-min-min-min-h-screen shadow-2xl border-x border-slate-900/50 overflow-x-hidden">
        <Routes>
